        ...
        <li>
          <Link to="1">
            <div className="media media-50">
              <img
                className="rounded"
                src="/assets/images/message/pic1.jpg"
                alt="image"
              />
            </div>
        ...
        <li>
          <Link to="1">
            <div className="media media-50">
              <img
                className="rounded"
                src="/assets/images/message/pic2.jpg"
                alt="image"
              />
            </div>
            <div className="media-content">
        ...
        <li>
          <Link to="1">
            <div className="media media-50">
              <img
                className="rounded"
                src="/assets/images/message/pic3.jpg"
                alt="image"
              />
            </div>
            <div className="media-content">
        ...
        <li>
          <Link to="1">
            <div className="media media-50">
              <img
                className="rounded"
                src="/assets/images/message/pic4.jpg"
                alt="image"
              />
            </div>
            <div className="media-content">
        ...
        <li>
          <Link to="1">
            <div className="media media-50">
              <img
                className="rounded"
                src="/assets/images/message/pic5.jpg"
                alt="image"
              />
            </div>
            <div className="media-content">
