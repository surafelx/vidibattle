      ...
      >
        ...
        {social_links?.instagram && (
          <SwiperSlide style={{ width: "60px" }}>
            <a
              ...
              target="_blank"
              className="mb-2 me-2 btn btn-icon"
              style={{ background: "#C13584", color: "#fff" }}
            >
              <i style={{ lineHeight: "0px" }} className="fab fa-instagram"></i>
            </a>
          </SwiperSlide>
        )}
        {social_links?.twitter && (
          <SwiperSlide style={{ width: "60px" }}>
            ...
            >
              <i style={{ lineHeight: "0px" }} className="fab fa-twitter"></i>
            </a>
          </SwiperSlide>
        )}
        ...
        {social_links?.linkedin && (
          <SwiperSlide style={{ width: "60px" }}>
            ...
            >
              <i style={{ lineHeight: "0px" }} className="fab fa-linkedin"></i>
            </a>
          </SwiperSlide>
        )}
        {social_links?.whatsapp && (
          <SwiperSlide style={{ width: "60px" }}>
            ...
            >
              <i style={{ lineHeight: "0px" }} className="fab fa-whatsapp"></i>
            </a>
          </SwiperSlide>
        )}
      </Swiper>
